...
#Examples
#Class: Admin
    #Creating and logging into admin account
Admin.register("myPassword")
Admin.login("IncorrectPassword")
Admin.login("myPassword")

#Class: AddItem
    #Adding items to table automatically
AddItem(100, "usb-c to usb-c", "wire", "length: 4ft", 6.99,1)
AddItem(101, "usb-c to usb-c", "wire","length: 10ft", 9.99, 1)
AddItem(200, "usb-a to usb-c", "wire", "length: 4ft",6.55,1)

    #Adding item to table via created object
AddItem.controlAutoAdd()
test = AddItem(200, "usb-a to usb-c", "wire", "length: 10ft",9.55,1)
AddItem.addToInventory(test)
...
Inventory.remove_item(201)

    #Updating quantity
Inventory.changeQuantity(100, 55)

    #Add Sale
Inventory.addSale(200, 3.99)
Inventory.addSale(100, 3.99)

    #Remove sale
Inventory.removeSale(100)
